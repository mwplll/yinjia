...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    createWindowMenu: function () {
        ...
        return {
            defaultAlign: 'br-tr',
            items: [
                { text: '刷新', handler: me.onWindowMenuRestore, scope: me },
...
//            win = module && module.createWindow();
        // TODO 自定义
        var me = this;
        var win = Ext.getCmp(record.data.module) || null;
        var ctr = coreApp.getController(record.data.controller);
//        ctr.subSystemId = record.data.subSystemId;
        if(!win){
            win = me.createWindow({
                ...
                layout:"fit",
                closeAction: 'hide',
                width: globalVariable.get("screenW") * 0.7,
                height: globalVariable.get("screenH") * 0.7,
